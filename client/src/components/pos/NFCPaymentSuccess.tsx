      ...
      <DialogContent className="max-w-md p-4 md:p-6">
        ...
        <div className="text-center">
          <div className="mb-4 md:mb-6">
            ...
            <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-1 md:mb-2">Payment Successful</h3>
            <p className="text-sm md:text-base text-gray-600">Payment has been completed successfully</p>
          </div>
          ...
          <div className="border border-gray-200 rounded-lg p-3 md:p-4 mb-4 md:mb-6">
            ...
            <div className="flex justify-between">
              <span className="text-xs md:text-sm text-gray-600">Remaining balance:</span>
